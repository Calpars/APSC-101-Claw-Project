...
const int SERVO_OPEN = 30; //Position of servo for claw to be open  //For first claw this value is 30, for second this value is 0
const int SERVO_CLOSED = 180; //Position of servo for claw to be closed //For first claw this value is 120, for second this value is 180
